  ...
  return (
    <>
      <div className="absolute inset-x-0 -mt-11 flex items-end" suppressHydrationWarning>
        <div className="mr-[calc(-1*(theme(spacing.8)-theme(spacing[1.5])))] h-11 flex-auto bg-slate-950 dark:bg-slate-200"></div>
        <div className="flex justify-between mx-auto w-full px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem]">
          <svg
            viewBox="0 0 56 48"
            aria-hidden="true"
            className="-ml-1.5 mb-[calc(-1/16*1rem)] w-14 flex-none overflow-visible fill-slate-950 dark:fill-slate-200"
          >
          ...
          <svg
            viewBox="0 0 56 48"
            aria-hidden="true"
            className="-mr-1.5 mb-[calc(-1/16*1rem)] w-14 flex-none overflow-visible fill-slate-950 dark:fill-slate-200"
          >
            <path d="M 53.314 3 H 60 V 48 H 0 V 47 H 2.686 A 8 8 0 0 0 8.343 44.657 L 47.657 5.343 A 8 8 0 0 1 53.314 3 Z"></path>
          </svg>
        </div>
        <div className="ml-[calc(-1*(theme(spacing.8)-theme(spacing[1.5])))] h-11 flex-auto bg-slate-950 dark:bg-slate-200"></div>
      </div>
      <section className="w-full py-12 md:p-24 lg:p-32 bg-gradient-to-b from-slate-950 to-slate-900 dark:from-slate-200 dark:to-slate-200">
        <div className="container px-4 mx-auto md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white dark:text-zinc-950">
                Adaptive Intelligent Tutoring System
              </h2>
              <p className="max-w-[700px] text-slate-200 dark:text-zinc-900 md:text-xl/relaxed">
